...
<div class="container special-width mt-3">
    <div class="row mt-5">
        <div class="col-md-6 search-media">
            <input id="searchName" onkeyup="searchByName(this.value)" class="form-control text-white bg-transparent" type="text" placeholder="Search By Name">
            </div>       
            <div class="col-md-6 search-media">
            <input id="searchF" onkeyup="searchByFirstLet(this.value)" class="form-control text-white bg-transparent" type="text" placeholder="Search By First Letter">
        </div>          
    </div>
</div>`
   ...
   finalResult.forEach((el)=>{
    ...
    <div class="col-md-3 cusItem "data-bs-toggle="modal" data-bs-target="#exampleModal" customeId= "${el.idMeal}" >
      <div class="home-meals position-relative rounded-2 overflow-hidden" >
          <img src="${el.strMealThumb}" class="w-100" alt="meal">
